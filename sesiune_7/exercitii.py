...
'''
13. Sa se scrie un program care citeste de la tastatura litere pana se introduce
un caracter care nu este litera. La final va afisa toate literele unice si sortate.'''
