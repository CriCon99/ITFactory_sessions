...
-> Sa se gaseana numele persoanelor care detin un Bike
-> Sa se gaseasca toate UtilityVehicle
'''


def find_vehicles_with_capacity_greater_than_2(vehicles):
    result = []
    for x in vehicles:
        if x.capacity > 2:
            result.append(x)
...
print(find_vehicles_with_capacity_greater_than_2(VEHICLES))
